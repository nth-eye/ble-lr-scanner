...
#ifndef MJKJ_HEADER_DRAGONBOX
#define MJKJ_HEADER_DRAGONBOX
...
// auto to_decimal(signed_significand_bits<Float, FloatTraits> signed_significand_bits, unsigned int exponent_bits, Policies... policies) noexcept {
//      using namespace detail::policy_impl;

//     // Assuming that return_sign and remove have boolean representations
//     constexpr bool sign_boolean = static_cast<bool>(sign::return_sign);
//     constexpr bool trailing_zero_boolean = static_cast<bool>(trailing_zero::remove);

//     using return_type =
//         decimal_fp<typename FloatTraits::carrier_uint, sign_boolean, trailing_zero_boolean>;
...
//     ret = detail::impl<Float, FloatTraits>::
...
//     // handle_sign(signed_significand_bits, ret);  // Please provide definition or replace this with appropriate function
//     return ret;
// }
