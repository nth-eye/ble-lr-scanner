#ifndef NTH_CONTAINER_POOL_H
#define NTH_CONTAINER_POOL_H
 ...
 * nth::bitset to store positions of elements.
 * 
 * @tparam T Type of elements
 * @tparam N Number of elements in pool
 * @tparam W Word type of nth::bitset, look its description
 * @tparam G Grow point of nth::bitset, look its description
 */
