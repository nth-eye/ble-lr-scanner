...
TEST(CborDecode, TextType)
{
    static constexpr const byte text_1[] = "hello";
    static constexpr const byte text_2[] = "world";

    static_assert(dec::text{text_1} == "hello");
    static_assert(dec::text{text_2} == "world");
    static_assert(dec::text{text_1} != "world");
    static_assert(dec::text{text_2} != "hello");

    ASSERT_EQ(dec::text{text_1}, "hello");
    ASSERT_EQ(dec::text{text_2}, "world");
    ASSERT_NE(dec::text{text_1}, "world");
    ASSERT_NE(dec::text{text_2}, "hello");
    ASSERT_EQ("hello", dec::text{text_1});
    ASSERT_EQ("world", dec::text{text_2});
    ASSERT_NE("world", dec::text{text_1});
    ASSERT_NE("hello", dec::text{text_2});
}

TEST(CborDecode, Unsigned)
{
    const byte test[] = { 
        0x00, // 0
        0x01, // 1
...
TEST(CborDecode, Floating)
{
    ...
    ASSERT_DOUBLE_EQ(o.floating(), 0.0);
    ...
    ASSERT_EQ(p, test + 9);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 1.0);
    ...
    ASSERT_EQ(p, test + 18);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 1.1);
    ...
    ASSERT_EQ(p, test + 21);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 1.5);
    ...
    ASSERT_EQ(p, test + 24);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 65504.0);
    ...
    ASSERT_EQ(p, test + 29);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 100000.0);
    ...
    ASSERT_EQ(p, test + 34);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 3.4028234663852886e+38);
    ...
    ASSERT_EQ(p, test + 43);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 1.0e+300);
    ...
    ASSERT_EQ(p, test + 46);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 5.960464477539063e-8);
    ...
    ASSERT_EQ(p, test + 49);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), 0.00006103515625);
    ...
    ASSERT_EQ(p, test + 52);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), -4.0);
    ...
    ASSERT_EQ(p, test + 61);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), -4.1);
    ...
    ASSERT_EQ(p, test + 64);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_DOUBLE_EQ(o.floating(), double(INFINITY));
    ...
    ASSERT_EQ(p, test + 67);
    ASSERT_EQ(o.type(), type_floating);
    ASSERT_TRUE(std::isnan(o.floating()));
...
TEST(CborDecode, Simple)
{
    ...
    ASSERT_EQ(e, err::ok);
    ASSERT_EQ(p, test + 1);
    ASSERT_EQ(o.type(), type_bool);
    ASSERT_EQ(o.boolean(), false);
    ...
    ASSERT_EQ(p, test + 4);
    ASSERT_EQ(o.type(), type_prim);
    ASSERT_EQ(o.prim(), prim_undefined);
...
TEST(CborDecode, Data)
{
    ...
    ASSERT_EQ(o.bytes().size(), 0);
    ASSERT_EQ(memcmp(first, o.bytes().data(), o.bytes().size()), 0);
    ...
    ASSERT_EQ(p, test + 6);
    ASSERT_EQ(o.type(), type_data);
    ASSERT_EQ(o.bytes().size(), 4);
    ASSERT_EQ(memcmp(second, o.bytes().data(), o.bytes().size()), 0);

    ASSERT_EQ(p, end);
}

TEST(CborDecode, Text)
{
    const byte test[] = {
        0x60, // ""
        0x61, 0x61, // "a"
    ...
    ASSERT_EQ(p, test + 14);
    ASSERT_EQ(o.type(), type_text);
    ASSERT_EQ(memcmp("\u00fc", o.string().data(), o.string().size()), 0);
    ...
    ASSERT_EQ(p, test + 18);
    ASSERT_EQ(o.type(), type_text);
    ASSERT_EQ(memcmp("\u6c34", o.string().data(), o.string().size()), 0);
    ...
    ASSERT_EQ(p, test + 23);
    ASSERT_EQ(o.type(), type_text);
    ASSERT_EQ(o.string(), dec::text(garbage, sizeof(garbage)));
...
TEST(CborDecode, Tag)
{
    ...
    ASSERT_EQ(content.string(), "2013-03-21T20:04:00Z");
    ...
    ASSERT_DOUBLE_EQ(content.floating(), 1363896240.5);
    ...
    ASSERT_EQ(content.bytes().size(), sizeof(data_1));
    ASSERT_EQ(memcmp(data_1, content.bytes().data(), content.bytes().size()), 0);
    ...
    content = o.tag().content();
    ASSERT_EQ(content.type(), type_data);
    ASSERT_EQ(content.bytes().size(), sizeof(data_2));
    ASSERT_EQ(memcmp(data_2, content.bytes().data(), content.bytes().size()), 0);
    ...
    content = o.tag().content();
    ASSERT_EQ(content.type(), type_text);
    ASSERT_EQ(content.string(), "http://www.example.com");

    ASSERT_EQ(p, end);
}

TEST(CborDecode, Array)
{
    const byte test[] = {
        0x80, // []
...
TEST(CborDecode, Constexpr)
{
    static constexpr const uint8_t test[] = { 
        0x01, // 1
        0x02, // 2
        0x0a, // 10
        0x17, // 23
    ...
    static_assert(73 == cnt);
}

TEST(CborDecode, ErrorOutOfBounds)
{
    err e;
    item o;
    pntr p;
...
TEST(CborDecode, ErrorReservedAi)
{
    err e;
    item o;
    pntr p;
...
TEST(CborDecode, ErrorInvalidBreak)
{
    err e;
    item o;
    pntr p;
...
TEST(CborDecode, ErrorInvalidIndefMt)
{
    err e;
    item o;
    pntr p;
    ...
    ASSERT_EQ(e, err::invalid_indef_mt);
    ASSERT_EQ(p, test_1.begin() + 1);
    ASSERT_EQ(o.type(), type_invalid);
